...
Future<void> showCollectionBottomSheet(
  BuildContext context,
  WidgetRef ref,
  Building building,
) async {
                          ...
                          if (isAdmin)
                            IconButton(
                              ...
                              onPressed: () async {
                                ...
                                if (confirm == true) {
                                  await buildingService.deleteBuilding(
                                    building.id,
                                  );
                                        ...
                                        builder: (ctx) => AlertDialog(
                                          ...
                                          actions: [
                                            ...
                                            ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                final buildingService = ref
                                                    .read(
                                                      buildingServiceProvider,
                                                    );
                                                if (buildingController.text
                                                        .trim()
                                                        .isNotEmpty &&
...
Future<void> showUnitAmountForm(
  BuildContext context,
  WidgetRef ref,
  Building building,
  Unit unit, {
  bool fromReports = false,
}) async {
  await showModalBottomSheet(
    context: context,
    isScrollControlled: true,
          ...
          children: [
            Row(
              ...
              children: [
                Flexible(
                  child: Text(
                    '${widget.building.name} - ${widget.unit.unitLabel}',
                    style: GoogleFonts.plusJakartaSans(
                      color: AppColors.textPrimary,
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
            ...
            if (widget.unit.photoBase64 != null) ...[
              GestureDetector(
                onTap: () =>
                    showZoomableImage(context, widget.unit.photoBase64!),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(8),
                  child: Image.memory(
              ...
              builder: (context) {
                ...
                return Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        isUpi ? LucideIcons.smartphone : LucideIcons.banknote,
                        size: 16,
                        color: color,
                      ),
            ...
            if (widget.unit.donationItem != null &&
                widget.unit.donationItem!.isNotEmpty) ...[
              const SizedBox(height: 12),
              Container(
                padding: const EdgeInsets.symmetric(
                  horizontal: 12,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        'Donated: ${widget.unit.donationItem!}',
                        style: GoogleFonts.plusJakartaSans(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                          color: AppColors.accent,
            ...
            if (widget.unit.phoneNumber != null &&
                widget.unit.phoneNumber!.isNotEmpty) ...[
              const SizedBox(height: 12),
              Container(
                padding: const EdgeInsets.symmetric(
                  horizontal: 12,
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(16),
                  border: Border.all(
                    color: AppColors.greenPin.withValues(alpha: 0.3),
                  ),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
            ...
            if (widget.unit.collectedBy != null &&
                widget.unit.collectedBy!.isNotEmpty) ...[
              const SizedBox(height: 12),
              FutureBuilder<DocumentSnapshot>(
                future: FirebaseFirestore.instance
                    .collection('collectors')
                    .doc(widget.unit.collectedBy)
                    .get(),
                builder: (context, snapshot) {
            ...
            if (widget.unit.collectedAt != null) ...[
              ...
              Text(
                '${DateFormat('yyyy-MM-dd').format(widget.unit.collectedAt!.toLocal())} at ${DateFormat('h:mm a').format(widget.unit.collectedAt!.toLocal())}',
                style: GoogleFonts.plusJakartaSans(
                  color: AppColors.textSecondary,
                  fontSize: 14,
                ),
            ...
            if (widget.unit.originalAmount != null) ...[
              ...
              FutureBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  final editorName =
                      corrData['correctedByName'] as String? ?? 'Admin';
                  final double oldAmt =
                      (corrData['oldAmount'] as num?)?.toDouble() ?? 0.0;
                  final double newAmt =
                      (corrData['newAmount'] as num?)?.toDouble() ?? 0.0;
                  final DateTime? editTime =
                      (corrData['timestamp'] as Timestamp?)?.toDate();
                  final editTimeStr = editTime != null
                      ? '${DateFormat('yyyy-MM-dd').format(editTime.toLocal())} at ${DateFormat('h:mm a').format(editTime.toLocal())}'
                      : '';
                  return Container(
            ...
            if (!isAdmin)
              Text(
                'Only admins can edit collected units.',
                style: GoogleFonts.plusJakartaSans(
                  color: AppColors.textSecondary,
                ),
              )
                      ...
                      onPressed: () async {
                        final confirm = await showDialog<bool>(
                          ...
                          builder: (ctx) => AlertDialog(
                            ...
                            content: Text(
                              'This will reset the amount to 0 and mark the unit as pending.',
                              style: GoogleFonts.plusJakartaSans(
                                color: AppColors.textSecondary,
                              ),
                            ),
        ...
        children: [
          Row(
            ...
            children: [
              Expanded(
                child: Text(
                  'Collect for: ${widget.building.name} - ${widget.unit.unitLabel}',
                  style: GoogleFonts.plusJakartaSans(
                    color: AppColors.textPrimary,
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
          ...
          if (!canCreate) ...[
            ...
            const SizedBox(height: 8),
            Text(
              'You do not have permission to collect funds.',
              style: GoogleFonts.plusJakartaSans(
                color: AppColors.textSecondary,
                fontSize: 14,
              ),
                ...
                onPressed: !_isSubmitValid
                    ...
                    : () async {
                        ...
                        try {
                          ...
                          final profile = ref
                              .read(collectorProfileProvider)
                              .value;
                          final collectorName = profile?.name ?? 'Admin';

                          if (phone.isNotEmpty) {
                            final isDuplicate = await buildingService
                                .isPhoneNumberInUse(
                                  phone,
